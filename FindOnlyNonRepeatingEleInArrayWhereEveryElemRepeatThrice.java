...
//Finding the only non-repeating element in an array where every element occurs thrice except one
public class FindOnlyNonRepeatingEleInArrayWhereEveryElemRepeatThrice {
...
//        System.out.println(Arrays.toString(bitsCount));
        ...
        for (int i = 0; i < bitsCount.length; i++) {
            if (bitsCount[i]%3==0) //here numbers in bitCount array can multiple of 3(3n...where n=0,1,2...) or 3n+1 or 1 or 0
